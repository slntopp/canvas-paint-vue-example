...
import Arrow from '@/components/editor/arrow'
import CropImage from '@/components/editor/crop'
import CanvasHistory from '@/components/editor/canvasHistory'
export default {
  name: 'Editor',
  props: {
    canvasWidth: {
        ...
        if (this.history[this.history.length - 1]) {
          if (this.history[this.history.length - 1].canvas) {
            ...
            if (
              ...
              const canvasObjects = this.history[this.history.length - 1].json
                .objects
